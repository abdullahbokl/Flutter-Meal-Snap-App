...
class CustomExpandableGroup extends StatefulWidget {
  ...
  @override
  _CustomExpandableGroupState createState() => _CustomExpandableGroupState();
}

class _CustomExpandableGroupState extends State<CustomExpandableGroup> {
